...
class CustomRedirections: MainRedirections {
    override fun register() {/* 屏蔽游戏错误捕获 */
        @GameSimulationLayer.GameSimulationLayer_KeyWords("setDefaultUncaughtExceptionHandler") redirect("com/corrodinggames/rts/gameFramework/l", arrayOf("aq", "()V"))

        /* 屏蔽游戏设置保存 */
        @GameSimulationLayer.GameSimulationLayer_KeyWords("preferences.ini") redirect("com/corrodinggames/rts/gameFramework/SettingsEngine", arrayOf("saveToFileSystem", "()Z")) { obj: Any, _: String, _: Class<*>, _: Array<out Any?> ->
        ...
        /* UUID 覆盖 */
        @GameSimulationLayer.GameSimulationLayer_KeyWords("serverUUID==null") redirect("com/corrodinggames/rts/gameFramework/j/ad", arrayOf("Z", "()Ljava/lang/String;")) { _: Any, _: String, _: Class<*>, _: Array<out Any?> ->
            return@redirect Data.core.serverHessUuid
        }

        /* MOD启用器覆盖(强制启用除自带以外) */
        @GameSimulationLayer.GameSimulationLayer_KeyWords("Loading mod selection") redirect("com/corrodinggames/rts/gameFramework/i/a", arrayOf("f", "()V")) { obj: Any, _: String, _: Class<*>, _: Array<out Any?> ->
            ...
            ("com.corrodinggames.rts.gameFramework.i.a".toClassAutoLoader(obj)!!.findField("e", ArrayList::class.java)!!
                .get(obj) as ArrayList<*>).forEach {
                // 过滤原版单位
