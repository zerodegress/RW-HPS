...
public class Json {
	...
	public static JSONObject getData(){
		...
		JSONObject object = JSONObject.parseObject(FileUtil.readfile(false,file.readconfig()).toString());
		return object;
	}
//
