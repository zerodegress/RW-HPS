...
package net.rwhps.server.util.zip.zip
...
internal class ZipFileDecoder: ZipDecoderUtils {
     ...
     */
    override fun getSpecifiedSuffixInThePackage(endWith: String): net.rwhps.server.struct.OrderedMap<String, ByteArray> {
        val data = net.rwhps.server.struct.OrderedMap<String, ByteArray>(8)
     ...
     * @return OrderedMap<String, ByteArray>
     */
    override fun getSpecifiedSuffixInThePackageAllFileName(endWith: String): net.rwhps.server.struct.OrderedMap<String, ByteArray> {
        val data = net.rwhps.server.struct.OrderedMap<String, ByteArray>(8)
        try {
     ...
     * @return OrderedMap<String, ByteArray>
     */
    override fun getSpecifiedSuffixInThePackageAllFileNameAndPath(endWithSeq: Seq<String>): net.rwhps.server.struct.OrderedMap<String, ByteArray> {
        val data = net.rwhps.server.struct.OrderedMap<String, ByteArray>(8)
        try {
            var zipEntry: ZipArchiveEntry
            IoRead.MultiplexingReadStream().use { multiplexingReadStream ->
    ...
    @NeedToRefactor
    override fun modsLoadingDedicated(): net.rwhps.server.struct.OrderedMap<String, ByteArray> {
        val data = net.rwhps.server.struct.OrderedMap<String, ByteArray>(8)
        try {
    ...
    override fun getZipAllBytes(): net.rwhps.server.struct.OrderedMap<String, ByteArray> {
        val data = net.rwhps.server.struct.OrderedMap<String, ByteArray>(8)
        try {
            var zipEntry: ZipArchiveEntry
            IoRead.MultiplexingReadStream().use { multiplexingReadStream ->
