...
import cn.rwhps.server.dependent.redirections.MainRedirections
...
class LwjglRedirections : MainRedirections {
    private val textureSize = System.getProperty(LwjglProperties.TEXTURE_SIZE, "1024").toInt()
    private val fullScreen = System.getProperty(LwjglProperties.FULLSCREEN, "true").toBoolean()
    private val screenWidth = System.getProperty(LwjglProperties.SCREEN_WIDTH, "1920").toInt()
    private val screenHeight = System.getProperty(LwjglProperties.SCREEN_HEIGHT, "1080").toInt()
    private val refreshRate = System.getProperty(LwjglProperties.REFRESH_RATE, "100").toInt()
    private val bitsPerPixel = System.getProperty(LwjglProperties.BITS_PER_PIXEL, "32").toInt()
    private val jniVersion = System.getProperty(LwjglProperties.JNI_VERSION, "24").toInt()
    ...
    fun register() {
        ...
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            ByteBuffer.wrap(
                ByteArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memRealloc" +
                    "(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            ByteBuffer.wrap(
                ByteArray(args[1] as Int)
            )
        }
        redirect(
            ...
            IntBuffer.wrap(
                IntArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/BufferUtils;createIntBuffer(I)" +
                    "Ljava/nio/IntBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            IntBuffer.wrap(
                IntArray(args[0] as Int)
        ...
        redirect(
            "Lorg/lwjgl/BufferUtils;createFloatBuffer(I)" +
                    "Ljava/nio/FloatBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            FloatBuffer.wrap(
                FloatArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;createIntBuffer(I)" +
                    "Ljava/nio/IntBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            IntBuffer.wrap(
                IntArray(args[0] as Int)
        ...
        redirect(
            "Lorg/lwjgl/BufferUtils;createByteBuffer(I)" +
        ...
        redirect(
            "Lorg/lwjgl/BufferUtils;createDoubleBuffer(I)" +
                    "Ljava/nio/DoubleBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            DoubleBuffer.wrap(
                DoubleArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memAllocInt(I)" +
                    "Ljava/nio/IntBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            IntBuffer.wrap(
                IntArray(args[0] as Int shl 2)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memAllocLong(I)" +
                    "Ljava/nio/LongBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            LongBuffer.wrap(
                LongArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memAllocDouble(I)" +
                    "Ljava/nio/DoubleBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            DoubleBuffer.wrap(
                DoubleArray(args[0] as Int)
        ...
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memAllocShort(I)" +
                    "Ljava/nio/ShortBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            ShortBuffer.wrap(
                ShortArray(args[0] as Int)
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryStack;malloc(I)" +
                    "Ljava/nio/ByteBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, args: Array<Any> ->
            ByteBuffer.wrap(
                ByteArray(args[0] as Int)
        ...
        redirect(
            "Lorg/lwjgl/opengl/GL15;glBufferData(IJI)V"
        ) { _: Any?,
            _: String?, _: Class<*>?, args: Array<Any?> ->
            currentBufferSize.set(args[1] as Long?)
            null
        }
        redirect(
            "Lorg/lwjgl/opengl/GL15;glMapBuffer(II)" +
                    "Ljava/nio/ByteBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, _: Array<Any?>? ->
            ByteBuffer.wrap(
                ByteArray(currentBufferSize.get().toInt())
            )
        }
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;" +
        ...
        redirect(
            STBIImageRedirection.DESC,
            STBIImageRedirection.INSTANCE
        )
        redirect(
            MemASCIIRedirection.DESC,
        ...
        redirect(
            "Lorg/lwjgl/openal/ALC10;alcOpenDevice(" +
                    "Ljava/lang/CharSequence;)J", Redirection.of(1L)
        )
        redirect(
            "Lorg/lwjgl/system/MemoryUtil;memSlice(" +
                    "Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;"
        ) { _: Any?, _: String?, _: Class<*>?, _: Array<Any?>? -> null }
    }
