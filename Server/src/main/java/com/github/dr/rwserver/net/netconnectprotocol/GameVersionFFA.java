...
public class GameVersionFFA extends AbstractGameVersion {
    public GameVersionFFA(@NotNull ConnectionAgreement connectionAgreement) {
        super(connectionAgreement);
    }

    @NotNull
    @Override
    public AbstractNetConnect getVersionNet(@NotNull ConnectionAgreement connectionAgreement) {
        return null;
    }
