...
import net.rwhps.server.util.file.FileStream
...
internal interface ZipDecoderUtils {
     ...
     */
    fun getSpecifiedSuffixInThePackage(endWith: String): net.rwhps.server.struct.OrderedMap<String, ByteArray>
     ...
     * @return OrderedMap<String, ByteArray>
     */
    fun getSpecifiedSuffixInThePackageAllFileName(endWith: String): net.rwhps.server.struct.OrderedMap<String, ByteArray>

    /**
     * 获取ZIP内的指定后辍的文件名(全名+路径)与bytes
     * @return OrderedMap<String, ByteArray>
     */
    fun getSpecifiedSuffixInThePackageAllFileNameAndPath(endWithSeq: Seq<String>): net.rwhps.server.struct.OrderedMap<String, ByteArray>

    /**
     * 获取ZIP内可读文本的文件名(全名+路径)与bytes
     * @return OrderedMap<String, ByteArray>
     */
    fun modsLoadingDedicated(): net.rwhps.server.struct.OrderedMap<String, ByteArray>
    ...
    fun getZipAllBytes(): net.rwhps.server.struct.OrderedMap<String, ByteArray>
