...
class LwjglRedirections: MainRedirections {
    ...
    override fun register() {
        ...
        redirect("Lorg/lwjgl/glfw/GLFW;glfwWaitEventsTimeout(D)V") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            Thread.sleep((args[0] as Double * 1000L).toLong())
            null
        }

        redirect("Lorg/lwjgl/glfw/GLFW;glfwGetTime()D") { _: Any, _: String, _: Class<*>, _: Array<out Any?> ->
            (System.nanoTime() - startTime) / 1000000000.0
        }

        // TODO: check this does what it's supposed to
        redirect("Lorg/lwjgl/glfw/GLFW;glfwGetFramebufferSize(J[I[I)V") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
        ...
        redirect("Lorg/lwjgl/Sys;getTime()J") { _: Any, _: String, _: Class<*>, _: Array<out Any?> -> System.nanoTime() / 1000000L }
        ...
        redirect("Lorg/lwjgl/system/MemoryUtil;memByteBuffer(JI)" + "Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ByteBuffer.wrap(ByteArray(args[1] as Int))
        }

        redirect("Lorg/lwjgl/system/MemoryUtil;" + "memAlloc(I)Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ByteBuffer.wrap(ByteArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;memRealloc" + "(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ByteBuffer.wrap(ByteArray(args[1] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryStack;" + "mallocInt(I)Ljava/nio/IntBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            IntBuffer.wrap(IntArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/BufferUtils;createIntBuffer(I)" + "Ljava/nio/IntBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            IntBuffer.wrap(IntArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/BufferUtils;createFloatBuffer(I)" + "Ljava/nio/FloatBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            FloatBuffer.wrap(FloatArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;createIntBuffer(I)" + "Ljava/nio/IntBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            IntBuffer.wrap(IntArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;" + "memAllocFloat(I)Ljava/nio/FloatBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            FloatBuffer.wrap(FloatArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/BufferUtils;createByteBuffer(I)" + "Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ByteBuffer.wrap(ByteArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/BufferUtils;createDoubleBuffer(I)" + "Ljava/nio/DoubleBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            DoubleBuffer.wrap(DoubleArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;memAllocInt(I)" + "Ljava/nio/IntBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            IntBuffer.wrap(IntArray(args[0] as Int shl 2))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;memAllocLong(I)" + "Ljava/nio/LongBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            LongBuffer.wrap(LongArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;memAllocDouble(I)" + "Ljava/nio/DoubleBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            DoubleBuffer.wrap(DoubleArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryUtil;memAllocShort(I)" + "Ljava/nio/ShortBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ShortBuffer.wrap(ShortArray(args[0] as Int))
        }
        redirect("Lorg/lwjgl/system/MemoryStack;malloc(I)" + "Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            ByteBuffer.wrap(ByteArray(args[0] as Int))
        }

        // TODO: this is really bad...
        redirect("Lorg/lwjgl/opengl/GL15;glBufferData(IJI)V") { _: Any, _: String, _: Class<*>, args: Array<out Any?> ->
            currentBufferSize.set(args[1] as Long?)
            null
        }
        redirect("Lorg/lwjgl/opengl/GL15;glMapBuffer(II)" + "Ljava/nio/ByteBuffer;") { _: Any, _: String, _: Class<*>, _: Array<out Any?> ->
