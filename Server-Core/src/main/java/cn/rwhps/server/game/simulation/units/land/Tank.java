...
public class Tank extends LandUnit {
    ...
    public static void load() {
        ...
        IMAGE = game.graphics.loadImage(R.drawable.tank1);
        IMAGE_WREAK = game.graphics.loadImage(R.drawable.tank1_dead);
        IMAGE_TURRET = game.graphics.loadImage(R.drawable.tank1_turret);
